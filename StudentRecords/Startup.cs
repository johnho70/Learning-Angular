...
namespace StudentRecords
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    options.UseSqlServer(Configuration.GetConnectionString("studentsSqlServerConnectionString"));
            //});

            //Add SqLite support
            services.AddDbContext<StudentsDbContext>(options =>
            {
                //options.UseSqlite(Configuration.GetConnectionString("studentsSqliteConnectionString"));
            ...
            services.AddTransient<StudentsDbSeeker>();
            //services.AddScoped<IstudentsRepository, studentsRepository>();
            //services.AddScoped<IStatesRepository, StatesRepository>();
            //services.AddTransient<studentsDbSeeder>();
        ...
        public void Configure(IApplicationBuilder app, 
            ...
            StudentsDbSeeker studentsDbSeeker,
            IAntiforgery antiforgery)
        {
            ...
            studentsDbSeeker.SeedAsync(app.ApplicationServices).Wait();
        }
    }
}
